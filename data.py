...
parser.add_argument('--folder_path', default='/home/camerart/cyj/test/graduation_design/training_data', type=str,
                    help='The folder path')
parser.add_argument('--train_filename', default='/home/camerart/cyj/test/graduation_design/training_data/training/training.flist', type=str,
                    help='The train filename.')
parser.add_argument('--validation_filename', default='/home/camerart/cyj/test/graduation_design/training_data/validation/validation.flist', type=str,
...
if __name__ == "__main__":
    ...
    # make output file if not existed
     ...
     #   os.open(args.train_filename, os.O_WRONLY)

    #if not os.path.exists(args.validation_filename):
        #os.open(args.validation_filename, os.O_WRONLY)
